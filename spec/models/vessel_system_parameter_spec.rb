...
RSpec.describe VesselSystemParameter, type: :model do
  describe '#lowest_satisfactory_range' do
    ...
    context 'when there is no min_satisfactory or max_satisfactory' do
      it 'returns range from chemical program parameter' do
        ...
        param = create :parameter
        chemical_provider_param = create :chemical_provider_parameter,
                                        system: system, parameter: param,
                                        min_satisfactory: 10, max_satisfactory: 20
        vessel = create :vessel, chemical_provider: chemical_provider_param.chemical_provider
  ...
  describe '#highest_satisfactory_range' do
    ...
    context 'when there is no min_satisfactory or max_satisfactory' do
      it 'returns range from chemical program parameter' do
        system = create :system
        param = create :parameter
        chemical_provider_param = create :chemical_provider_parameter, system: system, parameter: param,
                                                                     min_satisfactory: 10, max_satisfactory: 20
        vessel = create :vessel, chemical_provider: chemical_provider_param.chemical_provider
        vessel_system = create :vessel_system, vessel: vessel, system: system
        vessel_system_param = create :vessel_system_parameter, vessel_system: vessel_system, parameter: param,
  ...
  describe '#chemical_provider_parameter' do
    it 'selects correct parameter for given model' do
      chemical_provider = create :chemical_provider
      parameter = create :parameter
      system = create :system
      chemical_provider_parameter = create :chemical_provider_parameter, chemical_provider: chemical_provider,
                                                                       parameter: parameter, system: system
      vessel = create :vessel, chemical_provider: chemical_provider
      ...
      expect(vessel_system_parameter.chemical_provider_parameter).to eq(chemical_provider_parameter)
    end
  end
  ...
  describe '#recommendations' do
    it 'selects correct recommendations for given model' do
      ...
      chp1 = create :chemical_provider_parameter, chemical_provider: program
      chp2 = create :chemical_provider_parameter, chemical_provider: program
      chp3 = create :chemical_provider_parameter, chemical_provider: program
      vessel = create :vessel, chemical_provider: program
      ...
      rec1 = create :parameter_recommendation, chemical_provider_parameter: chp1
      rec2 = create :parameter_recommendation, chemical_provider_parameter: chp2
      rec3 = create :parameter_recommendation, chemical_provider_parameter: chp3
      rec4 = create :parameter_recommendation, chemical_provider_parameter: chp2
